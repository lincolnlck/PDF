...
def run_phraise_app():
    ...
    # Text Box 1의 기본 세팅값 설정
    default_lyrics_box_width = 33.86
    default_lyrics_box_height = 5.39
    default_lyrics_box_top = 7.00
    default_lyrics_box_left = 0.0
    default_lyrics_font_size = 60
    default_lyrics_font_name = '서울한강 장체 B'
    ...
    with col1:
        ...
        font_1 = st.text_input("Font for Text Box 1", default_lyrics_font_name, key="font_1")
        color_1 = st.color_picker("Color for Text Box 1", default_lyrics_color, key="color_1")
        size_1 = st.number_input("Font size for Text Box 1", value=default_lyrics_font_size, step=1, key="size_1")
        left_1 = st.number_input("Left position for Text Box 1 (cm)", value=default_lyrics_box_left, step=0.1, key="left_1")
        top_1 = st.number_input("Top position for Text Box 1 (cm)", value=default_lyrics_box_top, step=0.1, key="top_1")
        width_1 = st.number_input("Width for Text Box 1 (cm)", value=default_lyrics_box_width, step=0.1, key="width_1")
        height_1 = st.number_input("Height for Text Box 1 (cm)", value=default_lyrics_box_height, step=0.1, key="height_1")

    # Text Box 2의 기본 세팅값 설정
    default_english_box_width = 33.86
    default_english_box_height = 3.68
    default_english_box_top = 13.1
    default_english_box_left = 0.0
    default_english_font_size = 48
    default_english_font_name = '서울한강 장체 B'
    ...
    with col2:
        ...
        font_2 = st.text_input("Font for Text Box 2", default_english_font_name, key="font_2")
        color_2 = st.color_picker("Color for Text Box 2", default_english_lyrics_color, key="color_2")
        size_2 = st.number_input("Font size for Text Box 2", value=default_english_font_size, step=1, key="size_2")
        left_2 = st.number_input("Left position for Text Box 2 (cm)", value=default_english_box_left, step=0.1, key="left_2")
        top_2 = st.number_input("Top position for Text Box 2 (cm)", value=default_english_box_top, step=0.1, key="top_2")
        width_2 = st.number_input("Width for Text Box 2 (cm)", value=default_english_box_width, step=0.1, key="width_2")
        height_2 = st.number_input("Height for Text Box 2 (cm)", value=default_english_box_height, step=0.1, key="height_2")
